...
function setGlobalSectionsForView(viewName){
    ...
    // 店舗フィルタ＝全4タブ（出勤=週間の上／在籍・面談・管理=検索の上）。現タブのスロットへ移動
    var storeSlotId = ({ shift:'filter-slot-shift-store', all:'filter-slot-all', interview:'filter-slot-interview', url:'filter-slot-url' })[viewName] || '';
    var storeSlot = document.getElementById(storeSlotId);
    if (storeSlot && sf) storeSlot.appendChild(sf);
    if (sf) sf.style.display = storeSlot ? '' : 'none';
    // オキニフィルタ＝出勤タブのみ（今日のシフト直上）
    var okiniSlot = (viewName === 'shift') ? document.getElementById('filter-slot-shift') : null;
    if (okiniSlot && of_) okiniSlot.appendChild(of_);
    if (of_) of_.style.display = okiniSlot ? '' : 'none';
}
...
const NAMEGEN_DICT = {
    cute:
        'あん,うた,えみ,かの,きら,くみ,ここ,さな,しほ,すず,そら,ちか,つき,なな,にこ,のん,はな,ひな,ほの,まな,みう,もも,ゆあ,ゆず,りこ,りん,るる,れな,わか,'
        + 'あかり,いのり,うらら,かえで,きらら,ここな,ことね,さくら,しおり,すみれ,そよか,ちなつ,つむぎ,なぎさ,にいな,ののか,はるひ,ひまり,ふうか,ほなみ,まりん,みつき,'
        + 'もえか,ゆいな,ゆめか,りのん,るいか,れいな,わかば,あいりす,こころん,さくらこ,なゆたん,はなえみ,ひなたん,ふうりん,まりんか,ゆめのん,りんりん,ももたん,ひなのん,'
        + 'きらりん,ちゅらら,あこ,あの,いお,うみ,えり,おと,かや,きの,くう,けい,こと,さや,しずく,せな,たえ,ちさ,てん,とあ,なお,にな,ぬく,ねね,のえ,はる,ひかり,'
        + 'ふみ,ほし,まゆ,みお,むぎ,めい,もえ,やえ,ゆの,よつば,りお,るか,れみ,わたる,いちか,うたの,えみな,おとは,かのん,きこり,くるり,けいな,ことり,さやか,しののめ,'
        + 'せなか,たまき,ちはや,つくし,てまり,とわこ,なずな,にこり,ぬのか,ねいろ,のばら,はなの,ひかる,ふうこ,ほたる,まゆこ,みおり,むぎこ,めいか,もえの,やよい,ゆのん,'
        + 'よつは,りおな,るかな,れみか,わたか,あこりん,いおりん,うみのん,えりりん,おとちゃ,かやのん,きのぴー,くうたん,けいちゃ,ことりん,さやりん,せなちゃ,たえりん,ちさとん,'
        + 'てんてん,とあちゃ,なおのん,にななん,ねねりん,のえるん,はるりん,ふみりん,ほしのん,まゆたん,みおりん,むぎたん,めいたん,もえりん,やえちゃ,ゆのたん,りおりん,るかりん,'
        + 'れみりん',
    loli:
        'あむ,いち,えも,きゅ,さち,ちー,なぎ,ねね,のの,ぽむ,まめ,みみ,むぎ,ゆい,らむ,るう,ろこ,ここ,ぴの,あむね,いちご,うさぎ,えるる,きゅあ,くるみ,ここあ,こもも,'
        + 'さくり,しゅり,ちなみ,つぼみ,ぬくみ,ねねか,ののん,ぴのん,ふわり,ぽむこ,まめか,みるく,むぎの,もこな,ゆいぴ,らむね,りぼん,るうな,ろここ,あむりん,いちごん,うさぎん,'
        + 'きゅあら,くるみん,ここあん,こももん,つぼみん,ぴのぴの,ふわりん,まめまめ,みるきー,もこもこ,らむねん,りぼんぬ,るうるう,あず,いぬ,うり,えく,おは,かめ,きの,くろ,'
        + 'うさこん,えむりり,きゅるん,くろあん,ここねん,しゃろん,すぴかん,せろりん,ちぃちゃ,つみきん,てぃあら,とろとろ,なぎさん,にゃむり,ねむりん,のわーる,ひめのん,ふらんく,'
        + 'ほろびあ,まゆらん,みあんぬ,むくろん,めろうん,ゆめのん,りりかん,るなりあ,れむりあ,ろあんぬ',
    seiso:
        'あい,かな,きよ,さち,しの,すず,ちえ,なな,のあ,はる,ひな,まい,みき,ゆい,ゆう,りお,れん,わこ,えま,ここ,あおい,いずみ,かすみ,きよか,さちほ,しずく,すずね,'
        + 'ちひろ,なずな,のどか,はづき,ひなの,ふうこ,ほのか,まなみ,みずき,ゆいか,ゆきほ,りおん,わかこ,あおいろ,かすみか,きよのか,しずくり,すずかぜ,なのはな,ひなたか,'
        + 'ほのりん,みずきの,ゆきしろ,あさ,いち,うた,えみ,おと,かの,きの,くみ,けい,こと,さや,すみ,せり,そよ,たえ,ちさ,つき,てる,とわ,なお,にい,ぬの,ねね,のは,'
        + 'はの,ひの,ふみ,ほの,まき,みの,むつ,めい,もえ,やえ,ゆの,よし,りの,るの,れの,わの,あさの,いちの,うたの,えみの,おとの,かのの,きのは,くみの,けいの,ことの,'
        + 'さやの,しのの,すみの,せりの,そよの,たえの,ちさの,つきの,てるの,とわの,なおの,にいの,ぬのは,ねねの,のはら,はのん,ひのの,ふみの,ほのの,まきの,みのり,むつの,'
        + 'めいの,もえの,やえの,ゆのは,よしの,りのの,るのは,れのは,わのは,あさひな,いちのは,うたのは,えみのは,おとのは,かののは,きのはな,くみのは,けいのは,ことのは,さやのは,'
        + 'しののめ,すみのは,せりのは,そよのは,たえのは,ちさのは,つきのは,てるのは,とわのは,なおのは,ぬののは,ねねのは,のはらか,ひののは,ふみのは,ほののは,まきのは,みのりか,'
        + 'めいのは,もえのは,やえのは,ゆのはな,よしのは,りののは,わのはな',
    kirei:
        'あや,えり,かな,きえ,さき,しほ,せな,その,ちさ,なお,はる,ひろ,まき,みお,ゆき,りさ,れい,るか,れみ,わこ,あやか,えりな,かおる,さゆり,しずか,せりな,ちひろ,'
        + 'なつき,はるな,ひかる,まどか,みさき,ゆかり,れいか,るりか,わかな,のぞみ,ともか,あきな,ゆりな,しょうこ,きょうこ,りょうこ,きょうか,あやのり,かおりな,みさきな,'
        + 'ゆきのり,れいなん,ひろのか,あき,いく,うの,えみ,おり,かい,きり,くれ,けい,こう,さえ,しの,すい,せい,そう,たえ,つき,てい,とう,にの,ぬい,ねい,のえ,はく,'
        + 'ふう,へき,ほう,みや,むく,めい,もえ,やえ,ゆう,よう,りょ,るい,ろう,あきの,いくの,うのは,えみり,おりえ,かいり,きりか,くれは,けいり,こうか,さえり,しのり,'
        + 'すいれ,せいか,そうび,たえか,ちさき,つきか,ていか,とうか,なおり,にのは,ぬいか,ねいか,のえり,はくあ,ひろか,ふうか,ほうか,まきの,みやび,むくげ,めいり,やえか,'
        + 'ゆうか,ようか,るいか,ろうか,わこな,あきのり,いくのは,えみりあ,おりえん,かいりな,きりかね,くれはな,けいりな,こうかん,さえりな,しのりあ,すいれん,せいかん,そうびか,'
        + 'たえかな,ちさきな,つきかげ,とうかり,なおりな,ぬいかな,ねいかん,のえりあ,はくあん,ひろかね,ふうかん,まきのり,みやびか,めいりあ,やえかな,ゆうかり,ようかん,るいかな,'
        + 'れいかな,わこなり',
    iroke:
        'あゆ,えな,きさ,こい,さや,しずく,せり,そよ,ちあ,つや,なぎ,ねい,はづ,ひな,ふゆ,ほむ,まゆ,みや,めい,もあ,ゆず,りお,るい,れん,あゆみ,えなり,かれん,きさら,'
        + 'こいろ,さやね,しずり,せりか,そよぎ,ちあき,つやか,なぎほ,ねいろ,のえみ,はづき,ひなり,ふゆか,ほむら,まゆら,みやび,めいり,もあな,ゆずは,りおな,るいさ,れんか,'
        + 'あゆみか,えなりあ,かれんな,きさらぎ,こいごろ,さやねん,しずりあ,せりかな,つやこん,なぎほな,ねいろん,ひなりあ,ふゆかぜ,ほむらび,まゆらん,みやびか,めいりあ,ゆずはな,'
        + 'りおなん,るいさら,あき,いず,うる,えま,おと,かの,きら,くれ,こと,さき,しの,すい,そら,ちさ,てい,とわ,なお,にな,ぬく,のあ,はな,ひめ,むく,やえ,よい,わか,'
        + 'あきら,いずな,うるは,えまり,おとめ,かのん,きらり,くれは,ことみ,さきほ,しのり,すいれ,せりな,そらは,ちさと,ていら,とわか,なおみ,になり,のあり,はなび,ひめり,'
        + 'むくげ,やえの,よいか,わかな,あきらな,いずなみ,うるはな,えまりな,おとめざ,かのんな,きらりん,くれはな,ことみか,さきほな,しのりあ,すいれん,せりなん,そらはな,ちさとみ,'
        + 'つやかぜ,とわかぜ,なおみか,のありあ,はなびら,ひめりあ,もあなん,やえのは,よいかぜ,れんかな,わかなえ',
    gal:
        'あげ,えま,かり,こな,さり,せな,そら,てん,なる,にゃ,ぴか,まじ,みか,もえ,ゆま,るあ,れあ,ろこ,あげは,えまり,かりん,ぎゃる,こなつ,さりな,じゅり,せなん,そらん,'
        + 'てんか,なるみ,にゃん,ぴかり,まじか,みかん,もえか,ゆまり,りぼん,るあな,れあん,ろこな,あげはん,えまりん,かりんぬ,こなつん,さりなん,じゅりあ,ぴかりん,みかんぬ,'
        + 'もえかん,ゆまりん,るあなん,れあなん,ぎゃるみ,てんしー,あや,いぶ,うた,えな,おり,かれ,きく,くう,けい,こま,しゅ,せり,そあ,ちか,てぃ,とあ,なぎ,にこ,ぬん,'
        + 'ねる,のわ,ひめ,ふう,ほの,まゆ,みく,むう,めい,もな,ゆず,らむ,りお,れい,ろあ,わか,あやめ,いぶき,うたね,えなり,おりび,かれん,きくり,くうか,けいり,こまち,'
        + 'しゅり,せりな,そあら,ちかり,てぃな,とあら,なぎさ,にこる,ぬんぬ,ねるり,のわる,ひめか,ふうな,ほのか,まゆり,みくる,めいな,もなか,ゆずき,らむね,りおん,れいな,'
        + 'ろあな,わかな,あやめん,いぶきん,うたねん,えなりん,かれんぬ,きくりん,くうかん,こまちん,しゅりあ,せりなん,そあらん,ちかりん,てぃなん,とあらん,なぎさん,にこるん,'
        + 'ねるりん,のわーる,ひめかん,ふうなん,ほのかん,まゆりん,みくるん,めいなん,もなかん,ゆずきん,らむねん,りおんぬ,れいなん,ろあなん,わかなん',
    boyish:
        'あお,かい,けい,せい,つき,なぎ,ひか,まこ,みず,ゆう,りく,れい,ろい,あおい,かいり,けいと,こうき,しゅん,せいら,そうた,たくみ,つかさ,とうか,なぎさ,ひかる,'
        + 'ふうが,ほうき,まこと,みずき,ゆうき,りくと,れいじ,ろいど,あおいろ,かいりん,けいとん,しゅんか,そうたん,たくみか,つかさく,ひかるん,ふうがく,まことん,みずきり,'
        + 'ゆうきー,りくとん,れいじー,いつ,うみ,えい,おと,きら,くう,こう,さく,しゅ,そう,たく,ちは,てん,とう,にい,ぬま,ねい,のぞ,はや,ふう,ほう,みな,むつ,めい,'
        + 'もと,やま,よう,るい,れん,わた,あおば,いつき,うみと,えいと,おとや,かいと,きらと,くうが,さくや,せいや,たくと,ちはや,てんま,とうま,なぎと,にいな,ねいと,のぞむ,'
        + 'はやと,みなと,むつき,めいと,もとき,やまと,ようた,るいと,れんと,わたる,あおばと,いつきと,うみとん,えいとん,おとやん,かいとん,きらとん,くうがん,こうきん,さくやん,'
        + 'しゅんと,せいやん,たくとん,ちはやと,てんまる,とうまん,なぎとん,ねいとん,のぞむと,はやとん,ひかると,ふうがん,みなとん,むつきん,めいとん,もときん,やまとん,ゆうきと,'
        + 'るいとん,れんとん,わたるん',
    kana:
        'アン,イヴ,エマ,カレ,キラ,クレ,サラ,シア,セラ,ソフ,ティ,ナオ,ニケ,ノア,ハナ,ピア,マヤ,ミア,メイ,モア,ユナ,ラナ,リナ,ルナ,レア,ロゼ,アンナ,イヴリ,エマリ,'
        + 'カレン,キララ,クレア,サラサ,シアラ,セラフ,ソフィ,ティナ,ナオミ,ニケラ,ノエル,ハンナ,ピアノ,マリア,ミアナ,メイリ,モアナ,ユリア,ラナン,リナリ,ルナリ,レアナ,'
        + 'ロゼリ,アンジェ,イヴリナ,エマリナ,カレンナ,クレアラ,サラサラ,シャルル,セラフィ,ソフィア,ティアラ,ナオミィ,ノエリア,ハンナリ,マリアン,ミアナリ,メイリナ,モアナリ,'
        + 'ユリアナ,ラナンナ,リナリア,ルナリア,レアナリ,ロゼリア,アイ,イオ,ウル,エラ,オリ,カヤ,キア,ケイ,コア,サヤ,スミ,ソル,トア,ヌア,ネロ,ヒナ,フェ,ヘラ,ホア,'
        + 'ムア,ヤナ,ヨナ,ロア,ワナ,アイラ,イオナ,ウルカ,エララ,オリガ,カヤナ,キアナ,ケイラ,コアラ,サヤナ,シアナ,スミレ,セラナ,ソルナ,トアナ,ヌアラ,ネロリ,ヒナタ,'
        + 'フェリ,ヘレナ,ホアナ,マヤナ,ヤナナ,ヨナナ,ラナナ,ロアナ,ワナナ,アイラナ,イオナリ,ウルカナ,エラリナ,オリガナ,カヤナリ,キアナリ,クレアナ,ケイラナ,サヤナリ,シアナリ,'
        + 'スミレア,ソルナリ,トアナリ,ナオミナ,ニケラナ,ヌアラナ,ネロリア,ヒナタリ,フェリナ,ヘレナリ,マヤナリ,ヤナナリ,ラナナリ,ロアナリ',
    sweets:
        'あめ,うめ,きな,くり,さと,しろ,すい,まめ,みつ,むぎ,もち,らむ,りん,れも,あめり,いもこ,うめか,かきの,きなこ,くりむ,こめこ,さとう,しろみ,すいか,ぜりー,そふれ,'
        + 'みやこじ,やまぶき,ゆうすげ,あき,いよ,うた,えい,おと,かや,きり,くれ,けい,さえ,せん,そう,つゆ,てい,にお,ぬい,ねん,ひな,へい,ほた,むつ,めい,よい,るい,'
        + 'ろう,あきの,いよの,うたの,えいの,おとぎ,かやの,きりの,くれは,けいの,ことの,さえの,しのの,すずの,せんの,そうの,たえの,ちよの,つゆの,ていの,とわの,なぎの,'
        + 'にほの,ぬいの,ねんの,のぶの,ひなの,ほたの,まつの,みやの,むつき,めいの,やえの,ゆうの,よいの,りんの,るいの,ろうの,わさの,あきのは,いよのは,うたのは,えいのは,'
        + 'おとぎば,かやのは,きりのは,くれはな,さえのは,すずのは,せんのは,たえのは,つゆくさ,とわのは,なぎのは,ぬいのは,のぶのは,はぎのは,ひなのは,ふじのは,ほたるび,むつきの,'
        + 'もみじば,やえのは,よいのは,りんのは,れんげそ,わさのは',
    hakanai:
        'あお,いろ,かげ,きえ,こと,さえ,しの,すい,せつ,たえ,ちる,つゆ,とわ,なみ,ふゆ,みや,ゆめ,より,るり,れい,あおば,いろは,うつせ,かげろ,きえな,くうか,ことは,'
        + 'さえか,しのぶ,すいか,せつな,そうび,たえこ,ちるり,つゆり,とわこ,なみだ,ぬくも,ねむり,のぞみ,はくあ,ひそか,ふゆめ,ほろび,まぼろ,みやび,むそう,ゆめじ,よりこ,'
        + 'るりは,れいむ,あおばこ,いろはに,うつせみ,かげろう,きえのは,ことのは,さえずり,しのぶれ,すいれん,せつなり,たまゆら,ちるはな,つゆのは,とわのは,はかなみ,ひそやか,'
        + 'ふゆのは,ほろびか,まぼろし,みやびか,よるのは,るりのは,あわ,うす,えい,おぼ,くう,けむ,そう,てん,にじ,ぬく,ねむ,のぞ,はく,ひそ,へだ,ほろ,まぼ,むそ,めい,'
        + 'もや,やみ,ろう,わす,あわゆ,うすみ,えいえ,おぼろ,きえの,けむり,すいれ,てんか,にじの,めいそ,もやの,やみよ,ろうそ,わすれ,あわゆき',
    shizen:
        'あさ,うみ,かぜ,きり,くも,しお,そら,たき,つき,つゆ,なぎ,にじ,のは,はな,ひかり,ふゆ,ほし,まつ,みず,もり,やま,ゆき,りん,れん,あさひ,うみか,かぜは,きりか,'
        + 'くもり,こけら,さめか,しおり,すなお,そらは,たきび,つきの,つゆき,なぎさ,にじか,ねぎら,のはら,はなび,ふゆの,ほしの,まつり,みずき,もりの,やまと,ゆきの,よぞら,'
        + 'りんど,れんげ,わたげ,あさぎり,うみかぜ,かぜのは,きりしま,こもれび,さざなみ,しおかぜ,すいれん,そらのは,たきしぶ,つゆくさ,なつぞら,にじいろ,のはらか,はなびら,'
        + 'ひかりの,ふゆぞら,ほしぞら,みずうみ,もりのは,ゆきしろ,よぞらん,わたぼこ,あき,いけ,えだ,おか,けい,こけ,さめ,すな,せせ,ちり,てん,とげ,ぬま,ねぎ,ひか,へき,'
        + 'むぎ,めい,よぞ,るり,ろか,わた,あきの,いけの,えだは,おかの,けいこ,せせら,ちりり,てんく,とげの,ぬまの,むぎの,めいこ,るりは,ろかの,あきのは,いけのは,えだはな,'
        + 'おかのは,くもりぞ,こけのは,せせらぎ,つきあか,てんくう,ぬまのは,まつかぜ,むぎばた,やまなみ,るりのは,れんげそ',
    kawari:
        'えぬ,つゆ,てん,あくび,いんこ,うにこ,おとぎ,かもめ,きぬよ,くらげ,けしの,こまち,ざくろ,すいか,せみら,ちりり,つゆり,てんき,なぞの,のりこ,はりね,ひじき,ふきの,'
        + 'ぽちこ,むくげ,めめこ,もずく,ろばこ,あくびこ,うにうに,かもめこ,こまちこ,しじまか,つゆくさ,てんとう,なぞなぞ,ひじきん,ぽちぽち,むくむく,もずくん,あんこ,えのき,'
        + 'おでん,きなこ,けらけ,こんぶ,しめじ,せんべ,そーだ,たいや,ちくわ,つくね,てるて,とうふ,なっと,にんじ,ぬーど,ねぎま,のりま,はんぺ,ふりか,へちま,ほたて,まんじ,'
        + 'みそし,むしぱ,めんま,やきそ,ゆばこ,よもぎ,らっき,りんご,るっこ,れんこ,ろーる,わかめ,あんこう,いんこり,えのきだ,おでんこ,きなこも,くらげこ,こんぶこ,ざくろん,'
        + 'しめじこ,すいかわ,せんべい,そーだす,たいやき,ちくわぶ,つくねこ,てるてる,とうふこ,なっとう,にんじん,ねぎまき,のりまき,はんぺん,ふりかけ,へちまこ,ほたてこ,まんじゅ,'
        + 'みそしる,めんまこ,やきそば,ゆばのこ,よもぎこ,らっきょ,るっこら,れんこん,わかめこ',
    myoji:
        '浅野|あさの,麻生|あそう,天海|あまみ,有馬|ありま,綾瀬|あやせ,蒼井|あおい,安達|あだち,秋吉|あきよし,朝丘|あさおか,石田|いしだ,一条|いちじょう,井川|いかわ,'
        + '稲森|いなもり,岩下|いわした,伊藤|いとう,五十嵐|いがらし,一色|いっしき,上原|うえはら,内田|うちだ,宇野|うの,鵜飼|うかい,右京|うきょう,江角|えすみ,榎本|えのもと,'
        + '江波|えなみ,遠藤|えんどう,大空|おおぞら,押切|おしきり,音無|おとなし,織田|おだ,小川|おがわ,尾上|おのえ,乙葉|おとは,片桐|かたぎり,神楽坂|かぐらざか,川島|かわしま,'
        + '香川|かがわ,笠置|かさぎ,加賀|かが,菊池|きくち,城戸|きど,桐谷|きりたに,如月|きさらぎ,北原|きたはら,草笛|くさぶえ,黒木|くろき,倉本|くらもと,九条|くじょう,'
        + '朽木|くちき,香坂|こうさか,小雪|こゆき,古都|こと,今野|こんの,高津|こうづ,早乙女|さおとめ,桜井|さくらい,佐久間|さくま,沢口|さわぐち,沢尻|さわじり,西城|さいじょう,'
        + '坂上|さかがみ,笹本|ささもと,篠原|しのはら,島崎|しまざき,白石|しらいし,白川|しらかわ,志摩|しま,新藤|しんどう,末広|すえひろ,鈴原|すずはら,菅野|すがの,諏訪|すわ,'
        + '瀬戸|せと,関口|せきぐち,泉水|せんすい,千堂|せんどう,染谷|そめや,相馬|そうま,園部|そのべ,高島|たかしま,竹内|たけうち,立花|たちばな,田村|たむら,滝沢|たきざわ,'
        + '谷崎|たにざき,千葉|ちば,千原|ちはら,茅野|ちの,千秋|ちあき,月丘|つきおか,津川|つがわ,月島|つきしま,寺島|てらしま,天城|あまぎ,手塚|てづか,戸田|とだ,常盤|ときわ,'
        + '富田|とみた,十朱|とあけ,鳥羽|とば,中谷|なかたに,長澤|ながさわ,夏木|なつき,名取|なとり,南野|なんの,永山|ながやま,西野|にしの,二階堂|にかいどう,新妻|にいづま,'
        + '仁科|にしな,沼田|ぬまた,額田|ぬかた,根津|ねづ,根岸|ねぎし,野際|のぎわ,野々村|ののむら,能勢|のせ,橋本|はしもと,長谷川|はせがわ,早川|はやかわ,羽田|はねだ,'
        + '葉山|はやま,広末|ひろすえ,檜垣|ひがき,樋口|ひぐち,姫野|ひめの,日向|ひゅうが,深津|ふかつ,藤原|ふじわら,冬月|ふゆつき,布施|ふせ,古谷|ふるや,逸見|へんみ,'
        + '別所|べっしょ,細川|ほそかわ,本田|ほんだ,星野|ほしの,堀北|ほりきた,松坂|まつざか,松嶋|まつしま,真木|まき,松雪|まつゆき,真山|まやま,三田|みた,水野|みずの,'
        + '水沢|みずさわ,宮沢|みやざわ,三上|みかみ,美空|みそら,向井|むかい,村上|むらかみ,武藤|むとう,毛利|もうり,望月|もちづき,森下|もりした,森高|もりたか,百瀬|ももせ,'
        + '八木|やぎ,柳原|やなぎはら,山口|やまぐち,山吹|やまぶき,矢沢|やざわ,八千草|やちぐさ,結城|ゆうき,由良|ゆら,弓月|ゆづき,吉永|よしなが,米倉|よねくら,横山|よこやま,'
        + '吉行|よしゆき,余貴|よき,六車|むぐるま,若尾|わかお,和久井|わくい,若林|わかばやし,若槻|わかつき,和泉|わいずみ',
    myojicommon:
        '青木|あおき,秋山|あきやま,浅井|あさい,阿部|あべ,新井|あらい,安藤|あんどう,飯田|いいだ,池田|いけだ,石井|いしい,石川|いしかわ,石田|いしだ,市川|いちかわ,'
        + '伊藤|いとう,井上|いのうえ,今井|いまい,岩崎|いわさき,上田|うえだ,上野|うえの,内田|うちだ,大久保|おおくぼ,大島|おおしま,太田|おおた,大塚|おおつか,大西|おおにし,'
        + '大野|おおの,大橋|おおはし,岡田|おかだ,岡本|おかもと,小川|おがわ,奥村|おくむら,小野|おの,加藤|かとう,金子|かねこ,亀井|かめい,川口|かわぐち,川崎|かわさき,'
        + '河野|かわの,菅野|かんの,菊地|きくち,岸本|きしもと,北村|きたむら,木下|きのした,木村|きむら,工藤|くどう,久保|くぼ,熊谷|くまがい,黒田|くろだ,桑原|くわはら,'
        + '小島|こじま,小松|こまつ,小林|こばやし,近藤|こんどう,斉藤|さいとう,坂本|さかもと,佐々木|ささき,佐藤|さとう,佐野|さの,柴田|しばた,清水|しみず,島田|しまだ,'
        + '杉山|すぎやま,鈴木|すずき,関口|せきぐち,瀬川|せがわ,園田|そのだ,曽根|そね,高木|たかぎ,高田|たかだ,高橋|たかはし,竹内|たけうち,武田|たけだ,田島|たじま,'
        + '田中|たなか,谷口|たにぐち,田辺|たなべ,田村|たむら,千葉|ちば,土屋|つちや,坪井|つぼい,寺田|てらだ,遠藤|えんどう,戸田|とだ,富田|とみた,豊田|とよだ,内藤|ないとう,'
        + '中川|なかがわ,中島|なかじま,中野|なかの,中村|なかむら,中山|なかやま,西田|にしだ,西村|にしむら,西山|にしやま,沼田|ぬまた,根本|ねもと,野口|のぐち,野村|のむら,'
        + 'むらさき,めいこ,もとえ,やすよ,やえこ,ゆかり,ゆきの,よしの,ようこ,りつ,りょうこ,るりこ,れいこ,れいら,わかな,わかこ',
    wakazuma:
        'あい,あゆみ,あかね,あさみ,あすか,あやか,いずみ,いくみ,いつか,うらら,うたね,えみ,えりか,えなり,おとは,かおり,かなえ,かすみ,かえで,きょうか,きさら,くみ,くるみ,'
        + 'けいこ,ことみ,こはる,さおり,さやか,さちか,しおり,しずく,すみれ,すずね,せりな,そのか,ちなつ,ちひろ,ちさと,つぐみ,つかさ,ともみ,ともか,なお,なつみ,なぎさ,'
        + 'にいな,ぬくみ,ねいろ,のぞみ,のどか,はるか,はづき,ひとみ,ひなの,ふみか,ふうこ,ほのか,まりえ,まどか,まなみ,みさと,みずき,みゆき,むつみ,めぐみ,もえこ,やすこ,'
        + 'やよい,ゆかり,ゆき,ゆいか,よしの,りえ,りさこ,るみ,れみ,れいな,わかな,わこ',
    otona:
        'あき,あや,かお,さち,しの,せい,ちえ,とも,なお,はな,ひろ,ふみ,まき,みち,むつ,やす,ゆう,よう,りつ,れい,わこ,あきこ,あやこ,かおり,きょう,こうこ,さちこ,'
        + 'しのぶ,せいこ,そうこ,ちえみ,ともえ,なおこ,のりこ,はなえ,ひろみ,ふみか,まきこ,みちる,むつみ,やすこ,ゆうこ,ようこ,りつこ,れいこ,わこな,あきこさ,あやのぶ,かおりこ,'
        + 'きょうこ,こうこな,さちこの,しのぶこ,せいこな,ちえみこ,ともえこ,なおこさ,のりこの,ひろみこ,ふみかこ,まきこさ,みちるこ,むつみこ,やすこな,ゆうこさ,ようこの,りつこさ,'
        + 'れいこさ,いく,うた,えつ,かず,きく,くに,けい,こう,すみ,せつ,たえ,つね,とし,のぶ,はる,ひで,まさ,ゆき,よし,わか,あきえ,いくえ,うたえ,えつこ,かずえ,きくえ,'
        + 'くにえ,けいこ,さちえ,しのえ,すみえ,せつえ,たえこ,つねえ,としえ,なおえ,のぶえ,はるえ,ひでえ,ふみえ,まさえ,みちえ,むつえ,やすえ,ゆきえ,よしえ,りつえ,わかえ,'
        + 'あきひめ,いくひめ,うたひめ,えつらん,かずのは,きくのは,くにのは,けいのは,さちのは,しののは,すみのは,たえのは,ちえのは,としのは,とものは,なおのは,のぶのは,はるのは,'
        + 'ふみのは,まさのは,みちのは,やすのは,ゆきのは,よしのは,れいのは,わかのは',
};

const NAMEGEN_TASTES = [
    // group: 'y' = 若年層向け（でりどす・アネキャン想定） / 'j' = 人妻・熟女向け（愛のしずく想定）
    { key: 'cute',        group: 'y', label: '可愛い系' },
    { key: 'loli',        group: 'y', label: 'ロリ系' },
    { key: 'kira',        group: 'y', label: 'キラキラ系' },
    { key: 'jirai',       group: 'y', label: '地雷・量産型' },
    { key: 'seiso',       group: 'y', label: '清楚系' },
    { key: 'kirei',       group: 'y', label: '綺麗系' },
    { key: 'iroke',       group: 'y', label: '色気系' },
    { key: 'gal',         group: 'y', label: 'ギャル系' },
    { key: 'boyish',      group: 'y', label: '中性・ボーイッシュ' },
    { key: 'kana',        group: 'y', label: 'カタカナ・外国風' },
    { key: 'sweets',      group: 'y', label: 'スイーツ系' },
    { key: 'animal',      group: 'y', label: '動物系' },
    { key: 'kofu',        group: 'y', label: '古風・和風' },
    { key: 'hakanai',     group: 'y', label: '儚げ・文学系' },
    { key: 'shizen',      group: 'y', label: '季節・自然系' },
    { key: 'kawari',      group: 'y', label: '変わり系' },
    { key: 'myoji',       group: 'j', label: '苗字（女優系）' },
    { key: 'myojicommon', group: 'j', label: '苗字（普通）' },
    { key: 'showa',       group: 'j', label: '昭和・〇〇子系' },
    { key: 'madam',       group: 'j', label: '上品な奥様・マダム系' },
    { key: 'wakazuma',    group: 'j', label: '若妻系' },
    { key: 'otona',       group: 'j', label: '大人・色気系' },
];

/** 苗字カテゴリ（漢字表記。AI生成でも漢字を許可する判定に使う） */
const NAMEGEN_KANJI_TASTES = ['myoji', 'myojicommon', 'madam'];
...
/**
 * 辞書を 表記→{disp, yomi, tastes} に展開（初回のみ・以降はキャッシュ）
 * ★ 辞書の1語は「かな」または「表記|よみ」（例: 吉永|よしなが）。
 *   ・画面に出すのは 表記
 *   ・頭文字の行は よみ で判定（漢字では行が分からないため）
 *   ・文字数は 表記 で判定（「吉永」は見たまま2文字が直感に合う）
 */
function nameGenParse_() {
    if (nameGenParsed) return nameGenParsed;
    const map = {};
    for (const key in NAMEGEN_DICT) {
        String(NAMEGEN_DICT[key]).split(',').forEach(raw => {
            raw = raw.trim(); if (!raw) return;
            const bar = raw.indexOf('|');
            const disp = bar >= 0 ? raw.slice(0, bar) : raw;
            const yomi = bar >= 0 ? raw.slice(bar + 1) : raw;
            if (!disp || !yomi) return;
            if (!map[disp]) map[disp] = { disp: disp, yomi: yomi, tastes: [] };
            if (map[disp].tastes.indexOf(key) < 0) map[disp].tastes.push(key);
        });
    }
    nameGenParsed = map;
    return map;
...
function nameGenCollect_(len, row, tastes) {
    ...
    for (const key in dict) {
        const e = dict[key];
        if (len && e.disp.length !== len) continue;          // 文字数は表記で判定
        if (row && nameGenRowOf_(e.yomi) !== row) continue;  // 行はよみで判定
        if (tastes.length && !tastes.some(t => e.tastes.indexOf(t) >= 0)) continue;
        if (inStore[e.disp]) { excluded++; continue; }       // この店舗で使用中→出さない
        out.push({
            name: e.disp,
            yomi: (e.yomi !== e.disp) ? e.yomi : '',
            tastes: e.tastes,
            mainUsed: !!used.main[e.disp]
        });
    }
...
async function nameGenAI() {
    ...
    try {
        ...
        // ★ 苗字系のテイストが選ばれていたら、AI側にも漢字表記を許可させる
        const kanjiOk = st.tastes.some(k => NAMEGEN_KANJI_TASTES.indexOf(k) >= 0);
        const result = await apiCall('generateStageNames', {
            query: {
                store: st.store, len: st.len || '', row: st.row || '',
                tastes: tasteLabels.join(','), kanji: kanjiOk ? '1' : ''
            }
        });
        ...
        const seen = {};
        // ★ 苗字モードでは「漢字|よみ」で返るので分解する
        const list = (result.names || [])
            .map(n => String(n || '').trim())
            .map(n => { const b = n.indexOf('|'); return b >= 0 ? { name: n.slice(0, b), yomi: n.slice(b + 1) } : { name: n, yomi: '' }; })
            .filter(o => { if (!o.name || inStore[o.name] || seen[o.name]) return false; seen[o.name] = 1; return true; })
            .map(o => ({ name: o.name, yomi: o.yomi, tastes: ['ai'], mainUsed: !!used.main[o.name] }));
